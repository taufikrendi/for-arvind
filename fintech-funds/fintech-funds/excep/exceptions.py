...
except_status_406_still_on_application = HTTPException(
    status_code=406,
    detail="Can't Renew Loan Application",
    headers={"Content-Type": "application/json"},
)
...
except_status_406_not_finish_loan = HTTPException(
    status_code=406,
    detail="You are Still Have Installment!",
    headers={"Content-Type": "application/json"},
)
