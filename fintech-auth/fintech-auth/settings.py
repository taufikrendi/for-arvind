"""
Django settings for fintech-auth project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'fintech-auth/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(STATIC_ROOT, "fintech-auth/static"),
]
