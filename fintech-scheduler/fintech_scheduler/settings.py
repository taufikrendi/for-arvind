"""
Django settings for fintech_scheduler project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'fintech_scheduler/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASE_ROUTERS = ['route.routers.AuthRouter',
                    'route.routers.TransactionRouter',]
...
# STATICFILES_DIRS = [
#     os.path.join(STATIC_ROOT, "fintech_scheduler/static"),
# ]
...
APPEND_SLASH = True
DOMAIN_CONFIGURATION = '127.0.0.1:5001'
