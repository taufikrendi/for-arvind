...
class Banks(models.Model):
    ...
    class Meta:
        ordering = ('bank_code',)
        indexes = [models.Index(fields=['bank_id', 'bank_code']), ]


class Province(models.Model):
    province_id = models.UUIDField(
        primary_key=True, default=RandomUUID, editable=False, unique=True)
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['province_id', 'province_code']), ]
...
class District(models.Model):
    ...
    district_code = models.CharField(max_length=4, unique=True, null=False, validators=[numeric])
    district_relation = models.CharField(max_length=3, null=False, validators=[numeric])
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['district_id', 'district_code', 'district_relation']), ]


class SubDistrict(models.Model):
    sub_district_id = models.UUIDField(
        primary_key=True, default=RandomUUID, editable=False, unique=True)
    sub_district_name = models.CharField(max_length=30, null=False)
    sub_district_relation = models.CharField(max_length=4, null=False, validators=[numeric])
    sub_district_code = models.CharField(max_length=7, unique=True, null=False, validators=[numeric])
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['sub_district_id', 'sub_district_relation', 'sub_district_code']), ]


class LogNodeflux(models.Model):
    log_nodeflux_id = models.UUIDField(
        primary_key=True, default=RandomUUID, editable=False, unique=True)
    ...
    class Meta:
        ...
        indexes = [models.Index(fields=['log_nodeflux_id', 'log_nodeflux_job_id']), ]
