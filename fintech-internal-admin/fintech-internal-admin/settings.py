"""
Django settings for fintech-internal-admin project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [(os.path.join(BASE_DIR, 'fintech-internal-admin/templates')), ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASE_ROUTERS = ['route.routers.DefaultRouter',
                    'route.routers.FundsRouter',
